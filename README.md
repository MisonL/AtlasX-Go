...
- `atlasctl tabs list|open|activate|close|navigate|capture|extract-context|selection|suggest|memories|recommend-context|organize|devtools|emulate-device`
...
- `atlasd /v1/tabs|open|activate|close|navigate|context|semantic-context|selection|suggestions|memories|context-recommendations|organize|devtools|emulate-device`
