...
func TestTabOrganizeWindowGroupIntoWindowEndpointContract(t *testing.T) {
	...
	assertMapKeys(t, payload, "source_window_id", "target_window_id", "group_id", "label", "window_id", "returned", "moved_targets", "aligned_targets")
}
