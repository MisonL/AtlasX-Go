...
func (s *stubTabsClient) OpenDevToolsPanelWindowToWindows(sourceWindowID int, panel string) (tabs.DevToolsPanelWindowToWindowsResult, error) {
...
func (s *stubTabsClient) OpenDevToolsWindowIntoWindow(sourceWindowID int, targetWindowID int) (tabs.DevToolsWindowOpenResult, error) {
...
func TestTabContextEndpointSkipsMemoryWhenPersistenceDisabled(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
...
func TestSidebarAskEndpointSkipsMemoryWhenPersistenceDisabled(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
	t.Setenv("OPENAI_API_KEY", "test-key")
...
func TestSidebarSummarizeEndpointSkipsMemoryWhenPersistenceDisabled(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
	t.Setenv("OPENAI_API_KEY", "test-key")
