...
func serveTabOpenDevToolsWindowIntoWindow(w http.ResponseWriter, r *http.Request) {
	...
	result, err := client.OpenDevToolsWindowIntoWindow(request.SourceWindowID, request.TargetWindowID)
	if err != nil {
