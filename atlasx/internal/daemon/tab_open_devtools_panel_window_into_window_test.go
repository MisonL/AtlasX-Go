...
func TestTabsOpenDevToolsPanelWindowIntoWindowEndpoint(t *testing.T) {
	...
	request := httptest.NewRequest(
		...
		bytes.NewBufferString(`{"source_window_id":11,"panel":"network","target_window_id":21}`),
	)
	...
	for _, fragment := range []string{`"source_window_id":11`, `"panel":"network"`, `"target_window_id":21`, `"opened_targets":[`} {
...
func TestTabsOpenDevToolsPanelWindowIntoWindowEndpointRejectsMissingPanel(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
