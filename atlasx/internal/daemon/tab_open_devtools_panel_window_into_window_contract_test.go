...
func TestTabsOpenDevToolsPanelWindowIntoWindowEndpointContract(t *testing.T) {
	...
	assertMapKeys(t, payload, "source_window_id", "panel", "target_window_id", "returned", "opened_targets")
}
