...
func TestTabOrganizeGroupIntoWindowEndpointContract(t *testing.T) {
	...
	assertMapKeys(t, payload, "group_id", "label", "window_id", "returned", "moved_targets", "aligned_targets")
}
