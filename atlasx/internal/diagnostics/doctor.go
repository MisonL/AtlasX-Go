...
func (r Report) Render() string {
	lines := []string{
		...
		fmt.Sprintf("managed_session_ready=%t", r.Session.Ready),
		fmt.Sprintf("managed_session_stale=%t", r.Session.Stale),
		fmt.Sprintf("managed_session_state_cleaned=%t", r.Session.StateCleaned),
