...
type stubCommandTabsClient struct {
	...
	openDevToolsPanelWindowToWindowsErr  error
	...
	openDevToolsWindowIntoWindowErr      error
...
func (s *stubCommandTabsClient) OpenInWindow(windowID int, targetURL string) (tabs.WindowOpenResult, error) {
...
func (s *stubCommandTabsClient) MoveToWindow(targetID string, targetWindowID int) (tabs.WindowMoveResult, error) {
...
func (s *stubCommandTabsClient) MoveToNewWindow(targetID string) (tabs.WindowMoveToNewResult, error) {
...
func (s *stubCommandTabsClient) MergeWindow(sourceWindowID int, targetWindowID int) (tabs.WindowMergeResult, error) {
...
func (s *stubCommandTabsClient) SetWindowState(windowID int, state string) (tabs.WindowBounds, error) {
...
func (s *stubCommandTabsClient) SetWindowBounds(windowID int, left int, top int, width int, height int) (tabs.WindowBounds, error) {
...
func (s *stubCommandTabsClient) SetTitle(targetID string, title string) (tabs.TitleUpdateResult, error) {
...
func (s *stubCommandTabsClient) OpenDevToolsInWindow(targetID string, windowID int) (tabs.WindowOpenResult, error) {
...
func (s *stubCommandTabsClient) OpenDevToolsPanelInWindow(targetID string, panel string, windowID int) (tabs.WindowOpenResult, error) {
...
func (s *stubCommandTabsClient) OpenDevToolsWindowToWindows(sourceWindowID int) (tabs.DevToolsWindowToWindowsResult, error) {
...
func (s *stubCommandTabsClient) OpenDevToolsPanelWindowToWindows(sourceWindowID int, panel string) (tabs.DevToolsPanelWindowToWindowsResult, error) {
	if s.openDevToolsPanelWindowToWindowsErr != nil {
		return tabs.DevToolsPanelWindowToWindowsResult{}, s.openDevToolsPanelWindowToWindowsErr
	}
	return s.openDevToolsPanelWindowToWindows, nil
}

func (s *stubCommandTabsClient) OpenDevToolsPanelWindowIntoWindow(sourceWindowID int, panel string, targetWindowID int) (tabs.DevToolsPanelWindowOpenResult, error) {
	if s.openDevToolsPanelWindowIntoWindowErr != nil {
		return tabs.DevToolsPanelWindowOpenResult{}, s.openDevToolsPanelWindowIntoWindowErr
	}
	return s.openDevToolsPanelWindowIntoWindow, nil
}

func (s *stubCommandTabsClient) OpenDevToolsWindowIntoWindow(sourceWindowID int, targetWindowID int) (tabs.DevToolsWindowOpenResult, error) {
	if s.openDevToolsWindowIntoWindowErr != nil {
		return tabs.DevToolsWindowOpenResult{}, s.openDevToolsWindowIntoWindowErr
	}
	return s.openDevToolsWindowIntoWindow, nil
}
...
func (s *stubCommandTabsClient) Activate(targetID string) error {
...
func (s *stubCommandTabsClient) AuthMode(string) (tabs.AuthModeView, error) {
...
func (s *stubCommandTabsClient) DevToolsPanel(string, string) (tabs.DevToolsTarget, error) {
